			...
			<div class="custom-product-search">
				...
				<!-- <form role="search" method="get" class="shopper-product-search" action="<?php //echo esc_url( home_url( '/' ) ); ?>"> -->
					<!-- <div class="nav-left"> -->
						...
						<?php /* echo shopper_product_cat_select('indent_sub'); */ ?>
					<!-- </div> -->
					<!-- <div class="nav-right">
					...
					<!-- <div class="nav-fill"> -->
						...
						<input name="s" type="text" value="<?php //echo get_search_query(); ?>" placeholder="<?php //esc_attr_e( 'Buscar platos', 'shopper' ); ?>"/> -->
					<!-- </div> -->
				<!-- </form> -->
			</div>
			<?php
...
if ( ! function_exists( 'shopper_product_cat_select' ) ) {
	...
	function shopper_product_cat_select( $indent_sub = '', $select_id = 'product_cat_list' ) {
		...
		if ( count( $cats ) > 0 ) {
			...
			$select .= apply_filters('shopper_cat_all_option', '<option value="">'. esc_html__( 'Todos', 'shopper' ) .'</option>' );
