...
if ( ! function_exists( 'shopper_credit' ) ) {
	...
	function shopper_credit() {
		...
		<div class="site-info">
			...
			<?php echo esc_html( apply_filters( 'shopper_copyright_text', $content = '' . get_bloginfo( 'name' ) . ' &copy;' . date( 'Y' ) ) ) . ' - Todos los derechos reservados'; ?>.
...
if ( ! function_exists( 'shopper_backtotop ') ) {
	...
	function shopper_backtotop() {
		...
		if ( is_page('menu') || is_page('mesas') ) : ?>

		<!-- <span class="back-to-top"><i class="fa fa-chevron-up" aria-hidden="true"></i></span> -->

		<?php endif; ?>

		<?php if ( !is_page('home') && !is_page('inicio') && !is_home() && !is_page('carro') && !is_page('finalizar-comprar')&& !is_page('pagina-principal') && wp_is_mobile() ) : ?>

			<div class="custom-back-menu" id="js-dynamic-cart">
				<div class="custom-back-menu" id="js-data-cart">
					<a class="custom-see-my-order" href="<?php echo bloginfo('url') .'/carro'; ?>">Ver Pedido</a>

					<div class="custom-see-my-order">
						<?php global $woocommerce;
							$count = $woocommerce->cart->cart_contents_count; 
							echo sprintf( _n( '(%d) Tu Pedido', '(%d) Tu Pedido', $count, 'text domain' ), $count );
						?>
					</div>
				</div>
			</div>
