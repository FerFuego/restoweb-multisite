const CACHE_VERSION = '1.7.16';

const BASE_CACHE_FILES = [
    'https://restoweb.com.ar/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://restoweb.com.ar/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://restoweb.com.ar/?amp=1',
];

const NOT_FOUND_CACHE_FILES = [
    'https://restoweb.com.ar/menu/?amp=1',
];

const OFFLINE_PAGE = 'https://restoweb.com.ar/?amp=1';
const NOT_FOUND_PAGE = 'https://restoweb.com.ar/menu/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://restoweb.com.ar//wp-admin/');
//    },
];
